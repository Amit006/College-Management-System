...
<div class='offset-md-3 col-md-6 offset-md-3' style="background-color: #DAF7A6 ;">
	  		...
	  		<div class="panel-heading"><h1><span class="glyphicon glyphicon-user"></span> Student Entry Form</h1></div>
			    ...
			    <form method="post">
					...
					<div class="form-inline">
    					<select name="yy" class="form-control" style="width: 130px;">
       						<option>Year</option>
       						<?php
							$sel="";
							for($i=1985;$i<=2015;$i++){	
 ...
 -->    					<select name="mm" class="form-control" style="width: 130px;">
				...
				<div class="teacher_btn_pos">
					<input type="submit" name="btn_upd" href="#" class="btn btn-primary btn-lg" value="Update" />&nbsp;&nbsp;&nbsp;
...
<!-- for form Register-->
	<div class='offset-md-3 col-md-6 offset-md-3' style="background-color: #DAF7A6;">
				...
				<div class="panel panel-default">
				  		<div class="panel-heading"><h1><span class="fa fa-users"></span> Student Entry Form</h1></div>
				  			<div class="panel-body">
								<p class="lead well" style="text-align:center;">Here, you'll add new student's detail to record into database.</p>
							...
							<div class="form-group"> -->
		     				...
		     				<div class="teacher_bdayPlace_pos">
								...
								<div class="teacher_note_pos">
									<textarea type="text" name="notetxt" class="form-control" placeholder="Note" /></textarea>
								</div><br>
